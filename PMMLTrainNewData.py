...
# feet_data = analysis_data(raw_data[raw_data['Activity'] == 0][:125000])
# still_data = analysis_data(raw_data[raw_data['Activity'] == 1][:125000])
# vehicle_data = analysis_data(raw_data[raw_data['Activity'] == 2][:125000])
#
# df = pd.DataFrame()
